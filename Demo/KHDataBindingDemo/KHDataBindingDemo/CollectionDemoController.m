...
@interface CollectionDemoController () <KHDataBindingDelegate>
...
@implementation CollectionDemoController
{
    ...
    KHCollectionDataBinding *dataBinder;
...
- (void)viewDidLoad {
    ...
    dataBinder = [[KHCollectionDataBinding alloc] initWithView:self.collectionView delegate:self registerClass:@[[UserInfoColCell class]]];
    
    //  bind array
    userList = [dataBinder createBindArray];
//    userList2 = [dataBinder createBindArray];
    
    [dataBinder registerReusableView: [MyColHeaderView class] ];
    
    //  set header view
    [dataBinder setHeaderModel:[@{@"title":@"Header View"} mutableCopy] atIndex:0];
    [dataBinder setFooterModel:[@{@"title":@"Footer View"} mutableCopy] atIndex:0];
