#
#  Be sure to run `pod spec lint DataBindTest.podspec' to ensure this is a
...
Pod::Spec.new do |s|
  ...
  s.source       = { :git => "https://github.com/gevin/DataBindTest.git", :commit => "6c69d1d27f464d0399b6201bbbbd69273d5955db" }
  ...
  s.source_files  = "DataBind/TableViewBindHelper.h"
